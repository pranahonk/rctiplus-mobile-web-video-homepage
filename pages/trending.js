                                        ...
                                        <div className="program-container">
                                            <Row xs="2" className="wrapper-content-trending">
                                                {this.state.feeds[c.name] && this.state.feeds[c.name].map((feed, idx) => {
                                                    ...
                                                    if (idx % 5 === 0) {
                                                        if (idx === 0) {
                                                            return (<Col xs="12" className="box-trending" key={idx}><a href="#" onClick={() => this.goToDetail(feed)}><img className="box-img-trending" src={feed.cover} /><div className="font-trending-title-trending-parent" dangerouslySetInnerHTML={{ __html: title.substring(0, 60) }}></div></a></Col>);
                                                        } else {
                                                            return (<Col xs="12" className="box-trending" key={idx}><a href="#" onClick={() => this.goToDetail(feed)}><img className="box-img-trending" src={feed.cover} /><div className="font-trending-title-trending-child" dangerouslySetInnerHTML={{ __html: title.substring(0, 60) }}></div></a></Col>);
                                                        }
                                                    } else {
                                                        return (<Col xs="6" className="box-trending" key={idx}><a href="#" onClick={() => this.goToDetail(feed)}><img className="box-img-trending" src={feed.cover} /><div className="font-trending-title-trending-default" dangerouslySetInnerHTML={{ __html: title.substring(0, 60) }}></div></a></Col>);
                                                    }
                                                })}
                                            </Row>
                                        </div>
