...
class LiveEvent extends React.Component {
    ...
    static async getInitialProps(ctx) {
        ...
        const error_code = res[0].statusCode > 200 ? res[0].statusCode : false;
        const error_code_2 = res[1].statusCode > 200 ? res[1].statusCode : false;
            ...
            <Layout title="Live Event - RCTI+">
                ...
                <div className="wrapper-content" style={{ padding: 0, margin: 0 }}>
                    ...
                    <div className="title-wrap">
                        Live Chat Plus {formatDateWord(new Date(this.props.selected_event.data.start_date))}
                    </div>
