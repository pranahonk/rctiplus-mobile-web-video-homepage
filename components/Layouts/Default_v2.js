            ...
            <div style={{ height: '100%' }}  className={this.props.mobilePlatform}>
                <Head>
                    ...
                    <script dangerouslySetInnerHTML={{ __html: `
                        ...
                        'https://www.googletagmanager.com/gtm.js?id='+i+dl+ '&gtm_auth=ogx0OihVjJdMhvsmTnEFyA&gtm_preview=${GTM}&gtm_cookies_win=x';f.parentNode.insertBefore(j,f);
                    ...
                    <noscript key="gtm-noscript"><iframe src={`https://www.googletagmanager.com/ns.html?id=GTM-WJNRTJP&gtm_auth=ogx0OihVjJdMhvsmTnEFyA&gtm_preview=${GTM}&gtm_cookies_win=x`}
