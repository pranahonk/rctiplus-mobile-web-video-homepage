...
class StatusNotification extends React.Component {
    ...
    render() {
        return (
            <div id="invalid-feedback-top" className={'top-notification-container' + ' ' + (this.props.notification.progress ? 'notification-progress notification-show' : (this.props.notification.success ? 'notification-success' : 'notification-danger')) + ' ' + (this.props.notification.show ? 'notification-show' : '') + ' ' + (this.props.notification.size === 'medium' ? 'notification-medium' : '')}>
